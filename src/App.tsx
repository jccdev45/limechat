...
export default function App() {
  ...
  return (
    <div className="flex flex-col h-screen">
      <Tabs value={activeChannel || ''} onValueChange={setActiveChannel} className="flex flex-col flex-1">
        <ChannelTabs />
        {channels.map((channel) => (
          <TabsContent key={channel.name} value={channel.name} className="flex-1">
